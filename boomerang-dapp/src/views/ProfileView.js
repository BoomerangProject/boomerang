...
const ProfileView = (props) => (
  <div className="profile">
    ...
    <div className="profile-information">
      ...
      <p className="profile-description-label">Description</p>
      <p className="profile-description">{props.description}</p>
      <button onClick={props.editProfile} className="edit-profile-btn">
        Edit Profile
      </button>
    </div>
  </div>
